...
public class TimeLineAdapter extends ArrayAdapter<TimeLineModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.mDate = (TextView) convertView.findViewById(R.id.text_timeline_date);
        holder.mMessage = (TextView) convertView.findViewById(R.id.text_timeline_title);
        holder.mLeftImage = (ImageView) convertView.findViewById(R.id.left_img);
        holder.mRightImage = (ImageView) convertView.findViewById(R.id.right_img);
        holder.mTimelineView = (TimelineView) convertView.findViewById(R.id.time_marker);
        holder.mDate.setText(timeLineModel.getDate());
        holder.mMessage.setText(timeLineModel.getMessage());
        convertView.getLayoutParams().height = 220;
